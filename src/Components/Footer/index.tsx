        ...
        <div className="footer-bottom">
          <div className="footer-bottom-center">
            ...
            <div className="social-icons">
              <span><a href='#'><FaXTwitter className='twitter' /> Twitter </a></span>
              <span><a href='#'><FaInstagram className='instagram' /> Instagram </a> </span>
              <span><a href='#'><FaWhatsapp className='whatsapp' /> WhatsApp </a></span>
            </div>
          </div>
        </div>
