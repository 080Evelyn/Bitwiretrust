...
export const faqData: FAQItem[] = [
  {
    ...
    answer:
      "We offer secure solutions for utility payments, VTU recharge, gift card trading, and purchasing a variety of gift cards, all in one convenient platform.",
  },
  {
    question: "How long do transactions take to process?",
    answer:
      "Most transactions are processed instantly. However, some transactions may take up to 24 hours depending on the type of service.",
  },
  {
    question: "What types of gift cards can I trade or purchase?",
    answer:
      "We support a wide range of popular gift cards including Amazon, iTunes, Google Play, and many more international brands.",
  },
  {
    question: "How secure is my personal and financial information?",
    answer:
      "We use industry-standard encryption and security measures to protect all your personal and financial information.",
  },
  {
    question: "Can I track my transaction history?",
    answer:
      "Yes, you can easily track all your transactions through your account dashboard.",
  },
  {
...
export const transactions: TransactionRate[] = [
  ...
  },
  {
    ...
    description: "You have recieved 0.3237788 BTC",
    subdescription:
      "Your BTC wallet has been debited with transferred 0.3237788 BTC",
    status: "green",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    subdescription:
      "Top up your Airtime and mobile data and always stay updated on trending news.",
    status: "orange",
  },
  {
    id: "7",
