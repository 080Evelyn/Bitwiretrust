...
const Contact = (_props: Props) => {
  ...
  return (
    <div className="contact-form-container !mt-25">
      <div className="contact-form-header">
        <h1>Let's Talk</h1>
        <p className="subtitle">
          <span className="highlight">Reach out to us and let's discuss</span>,
          We are here to listen and help you achieve your goals
        </p>
      </div>
